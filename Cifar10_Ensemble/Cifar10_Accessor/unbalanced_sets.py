...
overbal_classes = [2, 3]
extra_data = ['data_batch_2', 'data_batch_3']
od = get_overbalanced_classes(overbal_classes, extra_data)
out_dict = make_unbalanced_dict('data_batch_1', od, 'birds_cats_1_23b')
out_dict = filter_classes(out_dict, overbal_classes, 0.25)
